...
export class CreateBlockchainIndexingStatusTable1692035734330 implements MigrationInterface {
    name = 'CreateBlockchainIndexingStatusTable1692035734330'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "public"."unique_blockchain_indexing_status"`);
